const CACHE = 'data-insight-v7';
const ASSETS = ['./', './index.html', './shared/styles.css', './shared/ux.css', './shared/app.js', './shared/data.js', './shared/charts.js', './manifest.webmanifest', './favicon.svg'];
